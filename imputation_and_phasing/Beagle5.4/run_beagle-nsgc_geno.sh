...
# Data parameters
GT_FILE="/panfs/jay/groups/9/morrellp/shared/Projects/Introgressed/vcf/morex_v3/Filtered/domesticated_snps.polymorphic.filt_miss_het.vcf.gz"
OUT_PREFIX="domesticated_snps.polymorphic.filt_miss_het.phased.imputed"
# Plink MAP file with cM positions
MAP_FILE="/panfs/jay/groups/9/morrellp/shared/Projects/Introgressed/vcf/morex_v3/Filtered/domesticated_snps.polymorphic.filt_miss_het.updated_cm.excluded_problem_markers.map"
# Duplicate markers to exclude
EXCLUDE_MARKERS="/panfs/jay/groups/9/morrellp/shared/Projects/Introgressed/vcf/morex_v3/Filtered/domesticated_duplicate_vars.dupvar"
...
# Landrace barley, theta estimate 0.0056
Ne="280000"
EM=true
