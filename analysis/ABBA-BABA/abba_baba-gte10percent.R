...
allele_freq_fp <- "~/Dropbox/Projects/Wild_Introgression/Analyses/ABBA_BABA/nsgc_and_wbdc_geno/wild_and_dom.Hmurinum.flare_gte10percent.derFreq.tsv.gz"

out_prefix <- "wild_and_dom.Hmurinum.flare_gte10percent"
